                               ...
                               String emailaddress=request.getParameter("emailaddress");
                                  String qualification=request.getParameter("qualification");
                                     String experience=request.getParameter("exp");
                                       ...
                                       response.getWriter().print("<script>alert('sucessful submitted');window.location.href='index.jsp';</script>");
                                        }
                                        else
                                      {
                                                response.getWriter().print("<script>alert('unsuccess');window.location.href='index.jsp';</script>");
                                       }
        }
         catch(Exception e)
         {
